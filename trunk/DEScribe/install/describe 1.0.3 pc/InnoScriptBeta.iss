...
OutputDir=.
OutputBaseFilename=DEScribe-1.0.3-setup
SetupIconFile=des-icon.ico
Compression=lzma
...
[Files]
Source: "DEScribe.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "sessions"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
